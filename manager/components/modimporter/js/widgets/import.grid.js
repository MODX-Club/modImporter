modImporter.grid.ImportGrid = function(config) {
    ...
    Ext.applyIf(config, {
        ...
        , autosave: true
        , columns: [
            {header: _('mdi_id'), dataIndex: 'id', width: 50}
            , {header: _('mdi_name'), dataIndex: 'name', width: 150, editor: {xtype: 'textfield', allowBlank: false}}
            , {header: _('mdi_format'), dataIndex: 'format', width: 70, editor: {xtype: 'textfield', allowBlank: false}}
            , {header: _('mdi_type'), dataIndex: 'type', width: 100, editor: {xtype: 'textfield', allowBlank: false}}
            , {header: _('mdi_source'), dataIndex: 'source', width: 100, editor: {xtype: 'textfield', allowBlank: false}}
            , {header: _('mdi_lastimportdon'), dataIndex: 'lastimportdon', width: 100}
            , {header: _('mdi_actions'), dataIndex: 'actions', renderer: modImporter.utils.renderActions,}
        ]
        , tbar: [{
...
Ext.extend(modImporter.grid.ImportGrid, MODx.grid.Grid, {
    ...
    , getImportFields: function(type) {
        return [
            ...
            , {xtype: 'textfield', fieldLabel: _('mdi_name'), name: 'name', allowBlank: false, anchor: '99%'}
            , {xtype: 'textfield', fieldLabel: _('mdi_description'), name: 'description', allowBlank: true, anchor: '99%'}
            , {xtype: 'mdi-combo-format', name: 'format'}
            , {xtype: 'mdi-combo-type', name: 'type'}
            , {xtype: 'mdi-combo-filebrowser', fieldLabel: _('mdi_source'), name: 'source', allowBlank: false, anchor: '99%'}
        ];
    }
